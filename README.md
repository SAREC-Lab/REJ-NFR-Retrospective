...
| ------------------ | ------------------------------------------------------- |
|[papers](papers/papers.md)| References and metadata for analyzed papers             |
...
| `docs/`            | Additional documentation and study materials            |
| `references/`      | BibTeX entries for foundational and cited papers        |
